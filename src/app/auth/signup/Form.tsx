                    ...
                    <Stack
                        ...
                        <Stack spacing={4}>
                            <Heading
                                ...
                                Rejoignez <Text as={'span'} bgClip="text">L</Text>ocal<Text as={'span'} bgClip="text">L</Text>ink
                                <Text as={'span'} bgClip="text">!</Text>
                            </Heading>
                        ...
                        >
                            {(props) => (
                                <Form>
                                    ...
                                    <Button onClick={() => router.push("/auth/signin")} textAlign={'center'} mt={4}
                                            w={'full'}>Déjà un compte ?</Button>
                                </Form>
                            )}
                        </Formik>
                    </Stack>
