...
export default function PostCard({ post, userLikes, setUserLikes }: { post: any, userLikes: any, setUserLikes: any }) {
        ...
        <Card w={isLargerThan1200 ? "auto" : "75%"} borderRadius={"20px"} boxShadow={shadow} cursor={"pointer"}
            ...
            >
                <Tooltip label="J'aime" aria-label="J'aime" placement="bottom">
                    <Button variant='brandGhostButton' leftIcon={<FiThumbsUp />} isActive={userLikes.includes(post.id)}
                        onClick={(e) => {
